  ...
  return (
    <>
      <div className="container-fluid">
        {/* Top Section */}
        <div className="bg-dark row border border-2 border-warning border-top-0 border-start-0 border-end-0 p-2">
          <div className="col-6 gap-1 text-start d-flex align-items-center">
            <svg
